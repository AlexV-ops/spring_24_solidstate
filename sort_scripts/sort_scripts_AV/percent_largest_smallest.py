...
def reorder_formula(formula):
    ...
    sorted_elements = sorted(atomic_percentages.items(), key=lambda x: x[1], reverse=True)
...
output_file = "output_percent_largest_smallest.xlsx"  # Change this to your desired output file name
